var conditions = {
	...
	weakness: {
		...
		ui: true,
		speed: -30,
		attacks_per_second: -0.015625,
		base_crit: -2,
		damage: -10,
		throw_range: -30,
		duration: 20000,
		explanation: "Reduces speed, attack speed, critical hit chance, damage, and throw range.",
	},
	xpower: {
	...
	purifier: {
		...
		buff: true,
		ui: true,
		explanation: "Boosts attack speed, damage output, damage, and throw range.",
	},
	mluck: {
		skin: "buff_luck",
		name: "Good Luck",
	...
	withdrawal: {
		...
		debuff: true,
		persistent: true,
		explanation: "Reduced combat effects.",
	},
	penalty_cd: {
		skin: "condition_bad",
