...
function runtimeRewardRoots(data, sources) {
	...
	for (const definition of [
		...
		},
		{
			...
			marker: 'add_item(player, "monstertoken", { log: true, q: reward_quantity })',
			probability: 1 / 500,
			...
			runtime_conditions: [
				...
				"reward uses the authoritative stored monster tier and preserves the hardcore 100x multiplier",
...
module.exports = {
	...
	roundEvidence,
	routeOverrideMap,
	runtimeEventDropRoots,
	runtimeEventExchangeRewardRoots,
